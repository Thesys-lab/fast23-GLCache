...
pub enum Policy {
    ...
    LearnedMerge {
        /// The maximum number of segments to merge in a single pass. 
        max_merge: usize,
        /// the expected number of segmetns to merge 
        n_merge: usize,

        train_interval_sec: u32, 

        // rerank every n_seg / rerank_interval / n_merge evictions 
        rerank_interval: u32,

        // wait time_before_first_train_data seconds before generate the first training data
        time_before_first_train_data: u32,
